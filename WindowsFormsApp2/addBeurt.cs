...
{
    public partial class addBeurt : Form
    {
        PRIJZEN[] prijzen;
        SUCCESS success;
        ...
        private async void addBeurt_Load(object sender, EventArgs e)
        {
            await getPrices();
        }
        ...
        private async Task SendInfo()
        {
            ...
            try
            {
                ...
                var response = await client.PostAsync(Data.server_address + "/add-user-beurt", content);
                ...
                if (response.StatusCode == HttpStatusCode.OK)
                {
                    ...
                    {
                        MessageBox.Show("Beurt toegevoegd.");
                        dashboard dash = new dashboard();
                        dash.Show();
                        this.Close();
                    }
                ...
                {
                    MessageBox.Show("Er ging iets mis, probeer het later opnieuw.");
                    addBtn.Enabled = true;
                }
            }
            catch (Exception ex)
